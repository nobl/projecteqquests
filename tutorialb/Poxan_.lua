...
function event_say(e)
	if (e.message:findi("hail") and eq.is_task_activity_active(22,6)) then -- Basic Training(22)
		...
		eq.popup("Schwimmen","<br>Beim Schwimmen kannst Du die Tasten<c \"#00c8f0\"> Bild Auf</c> und <c \"#00c8f0\">Bild Ab</c> verwenden, um Deinen Charakter nach oben oder unten zu richten. Du kannst dann mit den <c \"#00c8f0\">Pfeiltasten</c> normal schwimmen..<br><br><c \"#F07F00\">Springe ins Wasser und schnappe Dir Poxans Schwert unter der Brücke. Klicke dann auf 'OK', um fortzufahren.</c>",10,0,0);
	end
end
